	  ...
	  <div class="main">
	 	 <div class="contact">				
					<div class="contact_info">
						<h2>Your Wishlist Contains Below Products:</h2>
			    	 		<div class="map">
        ...
        if ($num > 0) {
            while ($row = mysqli_fetch_array($ret)) {
                ...
                <tr class="rem1">
                    ...
                    <td style="text-align:center;font-size: 20px">$<?php echo htmlentities(($row['productQty'] * $row['pprice'] *$diff) + $row['samt']); ?></td>
                    <td style="text-align:center;font-size: 20px">
            ...
            ?>
            <tr>
                <td style="font-size: 18px; color:red; font-weight:bold " colspan="7">Your wishlist is Empty.&nbsp;
                    <a href="products.php" class="btn-upper btn btn-warning">Continue Shopping</a>
                </td>
            </tr>
            <?php
