...
<form method="post" name="chngpwd" onSubmit="return valid();">
     <div class="row">
         <div class="col-2" style="font-weight: bold;">Current Password</div>
         <div class="col-8">    
            <input type="password" class="form-control" id="cpass" name="cpass" required="required"></div>
     </div>
       <div class="row mt-3">
         <div class="col-2" style="font-weight: bold;">New Password</div>
         <div class="col-8">
     <input type="password" class="form-control" id="newpass" name="newpass" required>
       ...
       <div class="row mt-3">
         <div class="col-2" style="font-weight: bold;">Confirm Password</div>
