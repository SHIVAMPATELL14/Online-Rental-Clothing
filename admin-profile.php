...
<html lang="en">
    <head>
        ...
        <title>Online Cloth Rental System | Admin Profile</title>
...
<form  method="post">                                
<div class="row">
<div class="col-3" style="font-weight: bold;">Admin userName(used for login)</div>
...
<div class="col-3" style="font-weight: bold;">Contact No.</div>
...
<div class="row" style="margin-top:1%;">
<div class="col-3" style="font-weight: bold;">Reg. Date</div>
...
<div class="row" style="margin-top:1%;">
<div class="col-3" style="font-weight: bold;">Profile Last Updation Date</div>
