...
count(if(orderStatus='Return', 0,null)) as returnorders,
                             ...
                             <div class="row">
                                ...
                                <div class="card bg-secondary text-white h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-white-75 small">Return Costume</div>
                                                <div class="text-lg fw-bold"><?php echo $returnorders; ?></div>
                                            </div>
    
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-white stretched-link" href="returned-orders.php">View Requests</a>
                                    </div>
                                </div>
                            </div>
