...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM tblrentalcloth where Category='$cid' ");
    ...
    $query=mysqli_query($con,"select tblrentalcloth.ID as pid,tblrentalcloth.Image1,tblrentalcloth.Title,tblrentalcloth.Priceperday,tblrentalcloth.ProductDescription,tblrentalcloth.SecurityAmount from tblrentalcloth where Category='$cid' order by pid desc LIMIT $offset, $total_records_per_page ");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?> 
							...
							<a class="cbp-vm-image" href="single.html">
							 <div class="view view-first">
								...
								<div class="product_image">
									...
									<div class="mask">
			                       		<div class="info"><a href="single-cloth-details.php?pid=<?php echo htmlentities($row['pid']);?>">Quick View</a></div>
					                  </div>
									<div class="product_container">
									   <div class="cart-left">
										 <p class="title"><?php echo htmlentities($row['Title']);?></p>
									   </div>
									   <div class="pricey">$<?php echo htmlentities($row['Priceperday']);?></div>
									   <div class="clearfix"></div>
								     </div>		
								  </div>
			                     </div>
